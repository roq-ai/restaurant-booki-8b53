...
export function MenuListPage(props: MenuListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'price', header: 'price', accessorKey: 'price' },
    {
      ...
      accessorKey: 'availability_start_time',
      cell: ({ row: { original: record } }: any) =>
        record?.availability_start_time ? format(record?.availability_start_time, 'dd-MM-yyyy') : '',
    },
    {
      id: 'availability_end_time',
      header: 'Availability End Time',
      accessorKey: 'availability_end_time',
      cell: ({ row: { original: record } }: any) =>
        record?.availability_end_time ? format(record?.availability_end_time, 'dd-MM-yyyy') : '',
    },
