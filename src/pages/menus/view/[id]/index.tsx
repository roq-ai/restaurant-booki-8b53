            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={data?.availability_start_time ? format(data?.availability_start_time, 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Availability End Time"
                  text={data?.availability_end_time ? format(data?.availability_end_time, 'dd-MM-yyyy') : ''}
                />
