  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, your comprehensive solution for table reservations and menu management, streamlining the dining experience for customers and staff alike."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, your comprehensive solution for table reservations and menu management, streamlining the dining experience for customers and staff alike.`}
            </Text>
            <Box
